...
const DashboardPage = async (props: Props) => {
    ...
    const notes = await db
        .select()
        .from($notes)
        .where(eq($notes.userId, userId!)); // ! ensures that the user is always here
        ...
        <>
            ...
            <Link href="/" className="flex items-center">
                ...
                <div className="max-w-7xl mx-auto p-10">
                    ...
                    <div className="h-8"></div>
                    { /* List all the notes */ }
                    { /* If not notes, display this */ }
                    {notes.length === 0 && (
                        <div className="text-center">
                        <h2 className="text-xl text-gray-500">You have no notes created yet.</h2>
                        </div>
                    )}
