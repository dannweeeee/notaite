...
const TipTapEditor = ({note}: Props) => {
    ...
    const { complete, completion } = useCompletion({
        api: "/api/completion",
    }); // complete is a function we call to trigger the endpoint, completion is a react state to get back all the tokens
    ...
    const editor = useEditor ({
        ...
        extensions: [StarterKit, customText], // add the starter kit extension
        content: editorState,
        onUpdate:({ editor }) => {
